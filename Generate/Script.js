...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const selectedSiteType = localStorage.getItem("selectedSiteType");
...
`;
  ...
  function Create_newSection(selectedCheckboxValue) {
    ...
    if (selectedCheckboxValue === "Citation") {
      ...
      const chevron_right = document.createElement("i");
      chevron_right.classList.add("bx");
      chevron_right.classList.add("bx-chevron-right");
      chevron_right.classList.add("button");
      chevron_right.id = "next";
      wrapper.appendChild(chevron_right);
      const image_container = document.createElement("div");
      image_container.classList.add("image-container");
      wrapper.appendChild(image_container);
      const carousel = document.createElement("div");
      carousel.classList.add("carousel");
      image_container.appendChild(carousel);
      let img_matrix = [
      ...
      localStorage.setItem("number_slide", 4);
      const number_img_in_slider = localStorage.getItem("number_slide");
      for (let i = 0; i < number_img_in_slider; i++) {
        const img1 = document.createElement("img");
        img1.src = img_matrix[i];
        carousel.appendChild(img1);
      }

      const chevron_left = document.createElement("i");
      chevron_left.classList.add("bx");
      chevron_left.classList.add("bx-chevron-left");
      chevron_left.classList.add("button");
      chevron_left.id = "prev";
      image_container.appendChild(chevron_left);
      ...
      iframe.setAttribute(
        "src",
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57151.58778704201!2d2.307570282021989!3d48.859606023815694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b70f%3A0x40b82c3688c9460!2sParis!5e0!3m2!1sfr!2sfr!4v1698594655945!5m2!1sfr!2sfr"
      );
    ...
    justify-content: center;
     ...
     -webkit-text-stroke: 2px #333;
      ...
      const gamesData = [
        {
          imgSrc:
            "https://imgs.search.brave.com/tX0wlbcnK4Cc882q8qEqpPEL6Oi5h0r1sBjKb_zt3CI/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/eHRyYWZvbmRvcy5j/b20vd2FsbHBhcGVy/cy9zcGlkZXItbWFu/LXBzNS0xMTA0OS5q/cGc",
          title: "Spider-Man PS5",
        },
        {
          imgSrc:
            "https://imgs.search.brave.com/3hMtS0sCkeB_Gi3kvTTRgqKkmG6eaW03owRoB37cUzg/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93YWxs/cGFwZXJjYXZlLmNv/bS93cC93cDc0NDE3/MTQuanBn",
          title: "God Of War",
        },
        {
          imgSrc:
            "https://imgs.search.brave.com/c3e8_pnWDjP9rnOIMiZkpWkPQx4mlyN_cX9tdQ1YjQM/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9jZG4t/dXBsb2Fkcy5nYW1l/YmxvZy5mci9pbWcv/bmV3cy80NDcxNjlf/NjRkZGM1NWIzYjVl/NC53ZWJwP3Zlcj0x",
          title: "Baldur's Gate 3",
        },
        {
          imgSrc:
            "https://imgs.search.brave.com/IvtvbYlDoCJi188MpoPQyKSPtO05lM62o01tXPoHmhs/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZS5qZXV4dmlkZW8u/Y29tL21lZGlhcy1z/bS8xNjMzMDEvMTYz/MzAwNjY3MC02NDE5/LWphcXVldHRlLWF2/YW50LmpwZw",
          title: "Elden Ring",
        },
        {
          imgSrc:
            "https://imgs.search.brave.com/kapB-szW0gokbOTFy3KxRNukpcZd45DKZ08Zt92qnsY/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93YWxs/cGFwZXJzLmNvbS9p/bWFnZXMvZmVhdHVy/ZWQvdGhlLWxhc3Qt/b2YtdXMtcjdmajZt/a2s4aGNreWkybS5q/cGc",
  ...
  function bar() {
    ...
    function section() {
      ...
      sections.forEach((section) => {
        ...
        // Variable pour stocker l'état du déplacement
        // Variables pour stocker l'état du déplacement
    ...
    header.addEventListener("click", () => {
      ...
      if (header.id === "background_color") {
        ...
        // code fond
        const colorfond = computedStyle.getPropertyValue("background-color");
        ...
        input_html_custom_forhtml.type = "text";
        ...
        input_css_custom_forhtml.type = "text";
    ...
    function generation() {
      ...
      if (selectedSection) {
        ...
        const input_generate = document.querySelector(".search_container .input_generate");
        ...
        if (h2Content && pContent && !excludedIds.includes(selectedSection.id)) {
          ...
          if (selectedSection) {
            ...
            if (card || body_edit) {
              ...
              input_paragraph_card.type = "text";
          ...
          if (selectedSection.id === "Slider") {
            ...
            if (card || body_edit) {
              ...
              input_counter.classList.add("input_counter");
              input_counter.type = "text";
              input_counter.value = number_img_in_slider;
              ...
              btn_save_notext.addEventListener("click", function () {
                ...
                if (number_img === "") {
                  ...
                  saved_create_notif();
                  const nb = number_img;
                  const nb_real = localStorage.getItem("number_slide");
                  const diff_nb = nb - nb_real;
                  localStorage.setItem("number_slide", nb);
                  let img_matrix4 = [
                    "https://images.unsplash.com/photo-1580191947416-62d35a55e71d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1742&q=80",
                    "https://images.unsplash.com/photo-1594323713852-9626155bfd37?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1674&q=80",
                    "https://images.unsplash.com/photo-1543332164-6e82f355badc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
          ...
          if (selectedSection.id === "Nos clients") {
            ...
            if (card || body_edit) {
              ...
              for (let i = 0; i < flex_colum.length; i++) {
                ...
                input_more_info_card.type = "text";
  ...
  setTimeout(() => {
    ...
    const header_bar_div = document.querySelector(".header_bar_div");
    ...
    voir_mon_site.addEventListener("click", function (event) {
      ...
      header_bar_div.style.padding = "0px"
...
${clonedDocument.documentElement.innerHTML}
      ...
      header_bar_div.style.padding = "1rem 2rem"
    });
    ...
    icon_download.addEventListener("click", () => {
      ...
      installer.addEventListener("click", function () {
        ...
        } const updatedContent = generatedContent.replace(/src="Script\.js"/gi, 'src="script.js"');
        ...
        if (typeof JSZip === 'undefined') {
          ...
          if (htmlCssJsContent) {
            ...
            const withoutScriptsAndStyles2 = generatedContent.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>|<style\b[^<]*(?:(?!<\/style>)<[^<]*)*<\/style>/gi, '');
      ...
      figma_design.addEventListener("click", async function () {
        ...
        // Élément à exclure
        const excludedElements = [
          "button_div", "bar_edit", "save_notif", "toast", "header_bar",
